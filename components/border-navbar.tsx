...
export const BorderNavbar = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <div className="min-w-[300px] h-[60px] relative border-2 border-neutral-300 dark:border-neutral-900 rounded-full bg-background flex flex-row items-center justify-around p-4 shadow-l gap-x-4">
